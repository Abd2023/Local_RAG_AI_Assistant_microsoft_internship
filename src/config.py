...
ALLOW_FOUNDRY_CPU_FALLBACK = _env_bool("FOUNDRY_ALLOW_CPU_FALLBACK", False)
UNLOAD_EMBEDDING_MODEL_AFTER_USE = _env_bool("FOUNDRY_UNLOAD_EMBEDDING_AFTER_USE", False)
UNLOAD_CHAT_MODEL_AFTER_USE = _env_bool("FOUNDRY_UNLOAD_CHAT_AFTER_USE", True)
...
CHAT_MAX_TOKENS = _env_int("RAG_CHAT_MAX_TOKENS", 220)
